...
5. **Google Sheets** → Appends to [Google SERP Scraping Database](<your-leads-sheet-url>)
...
- **Output:** [Google SERP Scraping Database](<your-leads-sheet-url>)
- **Workflow platform:** n8n Cloud (<your-n8n-instance>.n8n.cloud)
